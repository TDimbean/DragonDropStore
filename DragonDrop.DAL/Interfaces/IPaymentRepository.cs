...
namespace DragonDrop.DAL.Interfaces
{
    public interface IPaymentRepository
    {
        ...
        IEnumerable<Payment> GetAllFiltered(decimal amount, bool over, IEnumerable<Payment> payList = null);
        ...
        IEnumerable<Payment> GetAllFilteredAndPaged(string searchBy, int pgSize, int pgIndex, IEnumerable<Payment> payList = null);
        ...
        IEnumerable<Payment> GetAllByCustomerIdFilteredAndPaged(int custId, decimal amount, bool over, int pgSize, int pgIndex);
        ...
        #endregion
        bool PaymentIdExists(int payId);
        bool CustomerIdExists(int custId);
        bool PaymentMethodIdExists(int methId);
        #region Async
        Task CreateAsync(Payment pay);
        Task UpdateAsync(Payment pay);
        #region Gets
        Task<Payment> GetAsync(int id);
        Task<IEnumerable<Payment>> GetAllAsync();
        Task<IEnumerable<Payment>> GetAllPaginatedAsync
            (int pgSize, int pgIndex, IEnumerable<Payment> payList = null);
        Task<IEnumerable<Payment>> GetAllByCustomerIdAsync(int custId);
        Task<IEnumerable<Payment>> GetAllFilteredAsync
            (DateTime when, bool before, IEnumerable<Payment> payList = null);
        Task<IEnumerable<Payment>> GetAllFilteredAsync
            (decimal amount, bool over, IEnumerable<Payment> payList = null);
        Task<IEnumerable<Payment>> GetAllFilteredAsync
            (string searchBy, IEnumerable<Payment> payList = null);
        Task<IEnumerable<Payment>> GetAllSortedAsync
        ...
        #endregion
        Task<bool> PaymentIdExistsAsync(int payId);
        Task<bool> CustomerIdExistsAsync(int custId);
        Task<bool> PaymentMethodIdExistsAsync(int methId);
        #endregion
    }
}