...
{
    public class AdminProductsTabViewModel : BindableBase
    {
        #region Fields
        ...
        public AdminProductsTabViewModel(IProductDataService service)
        {
            _service = service;
            ...
            FilterSelChangedCommand = new DelegateCommand(FilterSelChangedCommandExecute);
        ...
        {
            get => new string[] { "ID", "Name", "Category", "Price", "Stock", "Barcode", "Description" };
        }
        ...
        public DelegateCommand FilterSelChangedCommand { get; }
        ...
        private void FilterSelChangedCommandExecute()
        {
